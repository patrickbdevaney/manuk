...
```
TICK:              1161
LAST_AUDIT_TICK:   1152          (self-audit due every 10 ticks — the hook BLOCKS commits past that)
...
LOOP_BUDGET:       3839 ticks remaining (target tick 5000) — from docs/loop/AUTOLOOP; the loop STOPS and reports at 0
LAST_WALL_AUDIT:   1146         (wall-time audit due every 20 ticks — scripts/wall-audit.sh; hunts wall bloat without cutting a gate)

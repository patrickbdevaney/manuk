...
```
TICK:              1140
LAST_AUDIT_TICK:   1131          (self-audit due every 10 ticks — the hook BLOCKS commits past that)
...
LOOP_BUDGET:       3860 ticks remaining (target tick 5000) — from docs/loop/AUTOLOOP; the loop STOPS and reports at 0

...
```
TICK:              384
LAST_AUDIT_TICK:   376          (self-audit due every 10 ticks — the hook BLOCKS commits past that)
LAST_SURFACE_AUDIT: 377         (surface audit due every 10 ticks — from docs/loop/SURFACE-AUDIT.md)
...
LOOP_BUDGET:       704 ticks remaining (target tick 1088) — from docs/loop/AUTOLOOP; the loop STOPS and reports at 0
LAST_WALL_AUDIT:   366         (wall-time audit due every 20 ticks — scripts/wall-audit.sh; hunts wall bloat without cutting a gate)

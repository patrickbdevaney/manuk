...
LAST_SURFACE_AUDIT: 743         (surface audit due every 10 ticks — from docs/loop/SURFACE-AUDIT.md)
...
LOOP_BUDGET:       345 ticks remaining (target tick 1088) — from docs/loop/AUTOLOOP; the loop STOPS and reports at 0

...
```
TICK:              1424
LAST_AUDIT_TICK:   1423          (self-audit due every 10 ticks — the hook BLOCKS commits past that)
LAST_SURFACE_AUDIT: 1423         (surface audit due every 10 ticks — from docs/loop/SURFACE-AUDIT.md)
...
LOOP_BUDGET:       3576 ticks remaining (target tick 5000) — from docs/loop/AUTOLOOP; the loop STOPS and reports at 0

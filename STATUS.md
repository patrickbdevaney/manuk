...
```
TICK:              356
LAST_AUDIT_TICK:   356          (self-audit due every 10 ticks — the hook BLOCKS commits past that)
...
LOOP_BUDGET:       732 ticks remaining (target tick 1088) — from docs/loop/AUTOLOOP; the loop STOPS and reports at 0

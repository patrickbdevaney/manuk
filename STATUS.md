...
```
TICK:              424
LAST_AUDIT_TICK:   415          (self-audit due every 10 ticks — the hook BLOCKS commits past that)
...
LOOP_BUDGET:       664 ticks remaining (target tick 1088) — from docs/loop/AUTOLOOP; the loop STOPS and reports at 0

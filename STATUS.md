...
LAST_SURFACE_AUDIT: 1050         (surface audit due every 10 ticks — from docs/loop/SURFACE-AUDIT.md)
...
LOOP_BUDGET:       3948 ticks remaining (target tick 5000) — from docs/loop/AUTOLOOP; the loop STOPS and reports at 0

...
```
TICK:              1060
LAST_AUDIT_TICK:   1051          (self-audit due every 10 ticks — the hook BLOCKS commits past that)
...
LOOP_BUDGET:       3940 ticks remaining (target tick 5000) — from docs/loop/AUTOLOOP; the loop STOPS and reports at 0

...
```
TICK:              1241
LAST_AUDIT_TICK:   1241          (self-audit due every 10 ticks — the hook BLOCKS commits past that)
...
LOOP_BUDGET:       3759 ticks remaining (target tick 5000) — from docs/loop/AUTOLOOP; the loop STOPS and reports at 0

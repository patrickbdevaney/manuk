...
```
TICK:              941
LAST_AUDIT_TICK:   940          (self-audit due every 10 ticks — the hook BLOCKS commits past that)
...
LOOP_BUDGET:       4059 ticks remaining (target tick 5000) — from docs/loop/AUTOLOOP; the loop STOPS and reports at 0

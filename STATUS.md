...
LAST_SURFACE_AUDIT: 428         (surface audit due every 10 ticks — from docs/loop/SURFACE-AUDIT.md)
...
LOOP_BUDGET:       658 ticks remaining (target tick 1088) — from docs/loop/AUTOLOOP; the loop STOPS and reports at 0

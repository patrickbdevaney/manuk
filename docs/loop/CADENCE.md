...
| **ticks per hour** | **0.78** | 154.1h elapsed |
...
* **live gates**: 27 → **68**
* **✅ rows in the capability ledger**: 144 → **268**
...
| **128** | 2026-07-17 15:11 | 30.6h | pattern-class | 55s | +315/−98 | 68 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

...
| **ticks per hour** | **0.95** | 126.5h elapsed |
...
* **live gates**: 27 → **63**
* **✅ rows in the capability ledger**: 144 → **233**
...
| **128** | 2026-07-16 11:30 | 2.9h | pattern-class | 50s | +129/−32 | 63 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

...
| **ticks per hour** | **0.91** | 132.4h elapsed |
...
* **live gates**: 27 → **65**
* **✅ rows in the capability ledger**: 144 → **247**
...
| **128** | 2026-07-16 17:24 | 8.8h | pattern-class | 51s | +118/−37 | 65 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

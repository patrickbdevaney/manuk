...
| **ticks per hour** | **0.88** | 136.8h elapsed |
...
* **live gates**: 27 → **65**
* **✅ rows in the capability ledger**: 144 → **253**
...
| **128** | 2026-07-16 21:48 | 13.2h | pattern-class | 59s | +137/−36 | 65 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

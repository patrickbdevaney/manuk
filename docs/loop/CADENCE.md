...
| **ticks per hour** | **0.69** | 173.4h elapsed |
...
* **live gates**: 27 → **87**
* **✅ rows in the capability ledger**: 144 → **309**
...
| **128** | 2026-07-18 10:25 | 2.1d | pattern-class | 57s | +619/−34 | 87 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

...
| **ticks per hour** | **0.95** | 126.1h elapsed |
| median verify wall | **55s** | 60 ticks |
| wall trend | 39s → 49s — getting slower ⚠️ | first 3 vs last 3 |
...
* **live gates**: 27 → **62**
* **✅ rows in the capability ledger**: 144 → **232**
...
| **128** | 2026-07-16 11:09 | 2.6h | pattern-class | 49s | +168/−36 | 62 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

...
| **ticks per hour** | **0.80** | 149.8h elapsed |
...
* **live gates**: 27 → **66**
* **✅ rows in the capability ledger**: 144 → **265**
...
| **128** | 2026-07-17 10:50 | 26.3h | pattern-class | 54s | +292/−40 | 66 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

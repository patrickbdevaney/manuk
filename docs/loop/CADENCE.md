...
| **ticks per hour** | **0.70** | 172.1h elapsed |
...
* **live gates**: 27 → **85**
* **✅ rows in the capability ledger**: 144 → **306**
...
| **128** | 2026-07-18 09:06 | 2.0d | pattern-class | 56s | +296/−58 | 85 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

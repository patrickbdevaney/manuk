...
| **ticks per hour** | **0.86** | 140.2h elapsed |
...
* **live gates**: 27 → **65**
* **✅ rows in the capability ledger**: 144 → **256**
...
| **128** | 2026-07-17 01:16 | 16.7h | pattern-class | 57s | +168/−34 | 65 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

...
| **ticks per hour** | **0.94** | 128.1h elapsed |
...
* **live gates**: 27 → **64**
* **✅ rows in the capability ledger**: 144 → **238**
...
| **128** | 2026-07-16 13:10 | 4.6h | pattern-class | 50s | +163/−18 | 64 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

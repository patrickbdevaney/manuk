...
| **ticks per hour** | **0.69** | 174.1h elapsed |
...
* **live gates**: 27 → **87**
* **✅ rows in the capability ledger**: 144 → **312**
...
| **128** | 2026-07-18 11:09 | 2.1d | pattern-class | 68s | +363/−42 | 87 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

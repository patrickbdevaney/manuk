...
| **ticks per hour** | **0.93** | 129.1h elapsed |
...
* **live gates**: 27 → **64**
* **✅ rows in the capability ledger**: 144 → **242**
...
| **128** | 2026-07-16 14:10 | 5.6h | pattern-class | 51s | +225/−34 | 64 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

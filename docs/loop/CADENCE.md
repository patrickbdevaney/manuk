...
| **ticks per hour** | **0.80** | 150.1h elapsed |
...
* **live gates**: 27 → **67**
* **✅ rows in the capability ledger**: 144 → **266**
...
| **128** | 2026-07-17 11:11 | 26.6h | pattern-class | 11m | +280/−32 | 67 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

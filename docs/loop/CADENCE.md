...
| fastest / slowest | 3m / 37.8h | |
| **ticks per hour** | **0.74** | 161.4h elapsed |
...
* **live gates**: 27 → **68**
* **✅ rows in the capability ledger**: 144 → **283**
...
| **128** | 2026-07-17 22:24 | 37.8h | pattern-class | 62s | +167/−8 | 68 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

...
| **ticks per hour** | **0.48** | 248.8h elapsed |
...
* **live gates**: 27 → **174**
* **✅ rows in the capability ledger**: 144 → **319**
...
| **128** | 2026-07-21 13:48 | 5.2d | pattern-class | 65s | +295/−47 | 174 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

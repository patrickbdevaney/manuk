...
| fastest / slowest | 3m / 37.3h | |
| **ticks per hour** | **0.75** | 160.8h elapsed |
...
* **live gates**: 27 → **68**
* **✅ rows in the capability ledger**: 144 → **282**
...
| **128** | 2026-07-17 21:49 | 37.3h | pattern-class | 59s | +245/−4 | 68 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

...
| | value | over |
|---|---|---|
| ticks landed | **135** | ticks 1–340 |
| median tick cycle | **20m** | 134 intervals |
| median, last 10 | **16m** | 10 intervals |
| fastest / slowest | 3m / 5.4d | |
| **ticks per hour** | **0.52** | 258.1h elapsed |
| median verify wall | **60s** | 74 ticks |
...
* median diff per tick: **+251 / −27** lines across 8 files

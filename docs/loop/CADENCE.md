...
| **ticks per hour** | **0.70** | 171.7h elapsed |
...
* **live gates**: 27 → **84**
* **✅ rows in the capability ledger**: 144 → **305**
...
| **128** | 2026-07-18 08:46 | 2.0d | pattern-class | 61s | +251/−31 | 84 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

...
| fastest / slowest | 3m / 2.0d | |
| **ticks per hour** | **0.70** | 172.4h elapsed |
...
* **live gates**: 27 → **86**
* **✅ rows in the capability ledger**: 144 → **307**
...
* median diff per tick: **+252 / −25** lines across 8 files
...
| **128** | 2026-07-18 09:25 | 2.0d | pattern-class | 58s | +252/−35 | 86 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

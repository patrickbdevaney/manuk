...
| **ticks per hour** | **0.82** | 146.6h elapsed |
...
* **live gates**: 27 → **65**
* **✅ rows in the capability ledger**: 144 → **263**
...
| **128** | 2026-07-17 07:37 | 23.1h | pattern-class | 53s | +144/−32 | 65 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

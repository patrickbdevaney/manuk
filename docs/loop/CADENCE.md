...
| fastest / slowest | 3m / 2.1d | |
| **ticks per hour** | **0.69** | 172.7h elapsed |
...
* **live gates**: 27 → **86**
* **✅ rows in the capability ledger**: 144 → **308**
...
| **128** | 2026-07-18 09:46 | 2.1d | pattern-class | 55s | +272/−44 | 86 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

...
| **ticks per hour** | **0.80** | 149.4h elapsed |
...
* **live gates**: 27 → **65**
* **✅ rows in the capability ledger**: 144 → **264**
...
| **128** | 2026-07-17 10:27 | 25.9h | pattern-class | 59s | +147/−8 | 65 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

...
| **ticks per hour** | **0.88** | 135.7h elapsed |
...
* **live gates**: 27 → **65**
* **✅ rows in the capability ledger**: 144 → **251**
...
| **128** | 2026-07-16 20:43 | 12.2h | pattern-class | 55s | +231/−21 | 65 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

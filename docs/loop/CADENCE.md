...
| | value | over |
|---|---|---|
| ticks landed | **303** | ticks 1–541 |
| median tick cycle | **21m** | 302 intervals |
| median, last 10 | **14m** | 10 intervals |
| fastest / slowest | 82s / 5.4d | |
| **ticks per hour** | **0.92** | 327.8h elapsed |
| median verify wall | **62s** | 242 ticks |
...
* median diff per tick: **+218 / −34** lines across 9 files

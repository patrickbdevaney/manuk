...
| **ticks per hour** | **0.90** | 133.9h elapsed |
...
* **live gates**: 27 → **65**
* **✅ rows in the capability ledger**: 144 → **249**
...
| **128** | 2026-07-16 18:54 | 10.3h | pattern-class | 53s | +127/−35 | 65 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

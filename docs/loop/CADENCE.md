...
| **ticks per hour** | **0.96** | 125.1h elapsed |
...
* **live gates**: 27 → **59**
* **✅ rows in the capability ledger**: 144 → **227**
...
| **128** | 2026-07-16 10:09 | 1.6h | pattern-class | 52s | +380/−22 | 59 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

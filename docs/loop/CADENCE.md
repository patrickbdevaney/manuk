...
| **ticks per hour** | **0.86** | 138.9h elapsed |
...
* **live gates**: 27 → **65**
* **✅ rows in the capability ledger**: 144 → **255**
...
| **128** | 2026-07-16 23:59 | 15.4h | pattern-class | 56s | +400/−77 | 65 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

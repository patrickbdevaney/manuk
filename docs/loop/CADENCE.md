...
| **ticks per hour** | **0.48** | 247.5h elapsed |
...
* **live gates**: 27 → **171**
* **✅ rows in the capability ledger**: 144 → **316**
...
| **128** | 2026-07-21 12:34 | 5.2d | pattern-class | 67s | +363/−37 | 171 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

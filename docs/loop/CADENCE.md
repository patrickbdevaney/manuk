...
| **ticks per hour** | **0.92** | 130.4h elapsed |
...
* **live gates**: 27 → **65**
* **✅ rows in the capability ledger**: 144 → **245**
...
| **128** | 2026-07-16 15:30 | 6.9h | pattern-class | 8m | +267/−13 | 65 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

...
| fastest / slowest | 3m / 40.8h | |
| **ticks per hour** | **0.73** | 164.3h elapsed |
...
* **live gates**: 27 → **68**
* **✅ rows in the capability ledger**: 144 → **287**
...
| **128** | 2026-07-18 01:20 | 40.8h | pattern-class | 8m | +318/−37 | 68 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

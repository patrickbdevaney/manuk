...
| **ticks per hour** | **0.88** | 136.2h elapsed |
...
* **live gates**: 27 → **65**
* **✅ rows in the capability ledger**: 144 → **252**
...
| **128** | 2026-07-16 21:17 | 12.7h | pattern-class | 54s | +232/−34 | 65 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

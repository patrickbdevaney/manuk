...
| **ticks per hour** | **0.69** | 173.7h elapsed |
...
* **live gates**: 27 → **87**
* **✅ rows in the capability ledger**: 144 → **311**
...
| **128** | 2026-07-18 10:47 | 2.1d | pattern-class | 58s | +384/−41 | 87 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

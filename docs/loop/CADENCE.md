...
| **ticks per hour** | **0.91** | 131.4h elapsed |
...
* **live gates**: 27 → **65**
* **✅ rows in the capability ledger**: 144 → **246**
...
| **128** | 2026-07-16 16:29 | 7.9h | pattern-class | 53s | +274/−105 | 65 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

...
| **ticks per hour** | **0.48** | 247.9h elapsed |
...
* **live gates**: 27 → **172**
* **✅ rows in the capability ledger**: 144 → **317**
...
| **128** | 2026-07-21 12:59 | 5.2d | pattern-class | 11m | +246/−34 | 172 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

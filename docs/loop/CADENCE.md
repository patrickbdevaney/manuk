...
| **ticks per hour** | **0.78** | 154.8h elapsed |
...
* **live gates**: 27 → **68**
* **✅ rows in the capability ledger**: 144 → **269**
...
| **128** | 2026-07-17 15:49 | 31.3h | pattern-class | 55s | +409/−49 | 68 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

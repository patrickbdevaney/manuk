...
| **ticks per hour** | **0.93** | 128.5h elapsed |
...
* **live gates**: 27 → **64**
* **✅ rows in the capability ledger**: 144 → **241**
...
| **128** | 2026-07-16 13:32 | 5.0h | pattern-class | 50s | +182/−37 | 64 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

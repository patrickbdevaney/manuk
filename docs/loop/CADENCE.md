...
| | value | over |
|---|---|---|
| ticks landed | **571** | ticks 1–833 |
| median tick cycle | **25m** | 570 intervals |
| median, last 10 | **54m** | 10 intervals |
| fastest / slowest | 5s / 5.4d | |
| **ticks per hour** | **1.10** | 519.4h elapsed |
| median verify wall | **63s** | 510 ticks |
...
* **live gates**: 27 → **379**
* **✅ rows in the capability ledger**: 144 → **432**
* **Bar 0 — oracle hangs**: 0 of 265 sites

**277 of 571 ticks** (49%) moved a
...
* **277** capability ticks, median cycle **25m**

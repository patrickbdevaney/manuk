...
| **ticks per hour** | **0.69** | 174.7h elapsed |
...
* **live gates**: 27 → **89**
* **✅ rows in the capability ledger**: 144 → **313**
...
| **128** | 2026-07-18 11:45 | 2.1d | pattern-class | 55s | +247/−32 | 89 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

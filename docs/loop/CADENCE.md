...
| | value | over |
|---|---|---|
| ticks landed | **902** | ticks 1–1200 |
| median tick cycle | **28m** | 901 intervals |
| median, last 10 | **37m** | 10 intervals |
| fastest / slowest | 5s / 5.4d | |
| **ticks per hour** | **1.14** | 791.0h elapsed |
| median verify wall | **63s** | 841 ticks |
...
* **live gates**: 27 → **454**
* **✅ rows in the capability ledger**: 144 → **594**
* **Bar 0 — oracle hangs**: 0 of 265 sites

**406 of 902 ticks** (45%) moved a
...
* **406** capability ticks, median cycle **28m**

...
| **ticks per hour** | **0.90** | 132.7h elapsed |
...
* **live gates**: 27 → **65**
* **✅ rows in the capability ledger**: 144 → **248**
...
| **128** | 2026-07-16 17:45 | 9.2h | pattern-class | 7m | +202/−35 | 65 | 81 | 46.8% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

...
| **ticks per hour** | **0.48** | 248.4h elapsed |
...
* **live gates**: 27 → **173**
* **✅ rows in the capability ledger**: 144 → **318**
...
| **128** | 2026-07-21 13:28 | 5.2d | pattern-class | 71s | +391/−57 | 173 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

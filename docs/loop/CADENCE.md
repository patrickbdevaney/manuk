...
| fastest / slowest | 3m / 2.2d | |
| **ticks per hour** | **0.68** | 175.3h elapsed |
...
* **live gates**: 27 → **90**
* **✅ rows in the capability ledger**: 144 → **314**
...
| **128** | 2026-07-18 12:19 | 2.2d | pattern-class | 58s | +317/−32 | 90 | 81 | 56.0% · | `Node.lookupPrefix` + the DocumentType namespace-lookup surface (+20 dom) |

...
const HTML: &str = r##"<!doctype html><html><head><style>
 ...
 window.addEventListener('load', function(){
   var Q=[
     ...
     // ── CONTROLS. The query production keeps media types, and the ordinary breakpoints that
     //    decide every real layout must answer exactly as they did before.
     ['notprint','not print'],
     ['screen',  'screen'],
     ['zero',    '(min-width:0)'],
...
fn media_conditions_evaluate_in_four_states_and_or_exists() {
    ...
    // ── PROVEN RED on FIVE mutations. The moved-row sets below are the ones actually OBSERVED,
    ...
    assert_eq!(
        ...
        "q_or=1 q_orf=0 q_oru=1 q_uorf=0 q_andu=0 q_nest=1 q_mix=0 q_notu=0 q_notge=0 q_notfn=0 \
         q_notparen=0 q_notbang=0 q_negmin=0 q_unitless=0 q_notprint=1 q_screen=1 q_zero=1 \
         q_wide=1 s_notprint=a.png s_all=a.png s_or=a.png s_notunk=a.png s_notfn=a.png \
